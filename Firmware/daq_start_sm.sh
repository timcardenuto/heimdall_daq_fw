...
# NOTE everything with sudo moved out of these scripts... 
...
_daq_core/rtl_daq.out 2> _logs/rtl_daq.log | \
...
env "PATH=$PATH" python3 _daq_core/hw_controller.py 2> _logs/hwc.log &
